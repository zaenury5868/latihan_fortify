        ...
        <div class="row">
            <div class="col-sm-6 login-section-wrapper">
                <div class="login-wrapper my-auto">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}"
                                class="form-control @error('name') is-invalid @enderror" placeholder="masukan nama lengkap">
                        </div>
                        <div class="form-group mb-4">
                            <label for="email">Email</label>
                            <input type="email" name="email" id="email" value="{{ old('email') }}"
                                class="form-control @error('email') is-invalid @enderror" placeholder="masukan email valid">
                            @error('email')
                    ...
                    <p class="login-wrapper-footer-text">sudah punya akun? <a href="{{ route('login') }}"
                            class="text-reset">Log in disini</a></p>
                </div>
            </div>
